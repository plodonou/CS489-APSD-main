...
//        var savedPatient = addNewPatient("P110", "John", "Walker");
...
//        var add = addressService.getAddressId(4);
//        var savedSurgery = addNewSurgery("S13", add);
//        System.out.println(savedSurgery);

//        System.out.println("Add new Appointment");
//        var patient = patientService.getPatientId(4);
//        var dentist = dentistService.getDentistId(3);
//        var surgery = surgeryService.getSurgeryId(4);
//        System.out.println("Patient name "+ patient.getFirstName());
//        var savedAppointment = addNewAppointment(LocalDate.of(2013,9,15 ),"18" ,dentist, patient, surgery);
...
//        System.out.println(patientService.getPatientByFirstNameStart("Lu"));
    ...
    private Patient addNewPatient(String patNo, String firstName, String lastname) {
        var patientAdd = addNewAddress("8th Street", "Chicago", "IL", "57894");
        var newPatient = new Patient(null, patNo, firstName, lastname, patientAdd);
...
//    }
    ...
    private Surgery addNewSurgery(String surgeryNo, Address address) {
        ...
        private Appointment addNewAppointment(LocalDate date, String time, Dentist dentist, Patient patient, Surgery surgery) {
        var newAppointment = new Appointment(null, date, time, dentist, patient, surgery);
